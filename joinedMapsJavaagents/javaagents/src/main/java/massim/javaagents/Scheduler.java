...
import massim.javaagents.agents.Team4Agent;
        ...
        for (AgentConf agentConf: agentConfigurations) {
            ...
            switch(agentConf.className){
                case "BasicAgent":
                    ...
                    break;
                case "Team4Agent":
                    agent = new Team4Agent(agentConf.name, mailService);
                    break;
...
//                    System.out.println("perceptupdate: " + pUpdate.toString());
        ...
        newPerceptAgents.forEach(massimTeam4agent -> {
                    //        updateGameStateByPerception();
//                    updateAgentStatesByPerception();
            ((MassimTeam4Agent) massimTeam4agent).updateStateByPerception();
//        updateMapsByPerception();
